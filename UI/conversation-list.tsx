...
export class ConversationList extends Component<Props, State> {
    ...
    render(props: Props) {
        ...
        return (
            <div class={`h-full flex flex-col mobile:w-full desktop:w-64 bg-[${SecondaryBackgroundColor}]`}>
                <div
                    class={`flex items-center gap-2 px-4 h-20 border-b border-[#36393F]`}
                >
                    <ButtonGroup class={`flex-1 ${LinearGradientsClass}} items-center`}>
                        ...
                        {IS_BETA_VERSION
                            ? (
                                <Fragment>
                                    <div class={`h-4 w-1 bg-[${PrimaryTextColor}] !p-0`}></div>
                                    <button
                                        onClick={async () => {
                                            props.emit({
                                    ...
                                    >
                                        <GroupIcon
                                            class={`w-4 h-4 mr-1 text-[${PrimaryTextColor}] fill-current`}
                                        />
                                        New Group
                                    </button>
                                </Fragment>
                ...
                <ul class={`bg-[#36393F] w-full flex h-[3rem] border-b border-[#36393F]`}>
                    <li
                        class={`h-full flex-1 cursor-pointer hover:text-[#F7F7F7] text-[#96989D] bg-[#2F3136] hover:bg-[#42464D] ${CenterClass} ${
                    ...
                    <li class={`w-[0.05rem] h-full bg-[#2F3136]`}></li>
                    <li
                        class={`h-full flex-1 cursor-pointer hover:text-[#F7F7F7] text-[#96989D] bg-[#2F3136] hover:bg-[#42464D] ${CenterClass} ${
            ...
            {pinned.map((contact) => {
                ...
                return (
                    ...
                    >
                        ...
                        <button
                            class={`w-6 h-6 absolute hidden group-hover:flex top-[-0.75rem] right-[0.75rem] ${IconButtonClass} bg-[#42464D] hover:bg-[#2F3136]`}
                            style={{
        ...
        <Fragment>
            ...
            >
                ...
                {props.newMessageCount > 0
                    ? (
                        <span
                            class={`absolute top-0 right-0 px-1 text-[${PrimaryTextColor}] text-xs rounded-full bg-[${ErrorColor}]`}
                        >
