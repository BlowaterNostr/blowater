    ...
    return (
        <div class={tw`flex mb-4 mx-5 items-end`}>
            ...
            >
                ...
                <span
                    class={tw`absolute block right-[0.5rem] bottom-[0.3rem] p-[0.5rem] rounded-2xl bg-[${HoverButtonBackgroudColor}] text-[${PrimaryTextColor}B2] text-[0.75rem]`}
                    style={{
                        boxShadow:
                            "0px 1px 0px 0px rgba(0, 0, 0, 0.14), 0px 1px 0px 0px rgba(255, 255, 255, 0.09) inset",
                    }}
                >
                    Ctrl+Enter
                </span>
