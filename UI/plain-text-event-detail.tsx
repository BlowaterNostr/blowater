        ...
        <div class={tw`py-[1.5rem] px-4`}>
            ...
            <div class={tw`relative`}>
                ...
                <OnFocusTransitionButton
                    onFocus={() => {
                        navigator.clipboard.writeText(eventIDBech32);
                    }}
            ...
            <div class={tw`relative`}>
                ...
                <OnFocusTransitionButton
                    onFocus={() => {
                        navigator.clipboard.writeText(authorPubkeyBech32);
                    }}
                    class={tw`absolute right-4 top-4`}
                />
            </div>
            <div class={tw`relative mt-4`}>
                ...
                <OnFocusTransitionButton
                    onFocus={() => {
                        navigator.clipboard.writeText(authorPubkey);
                    }}
                    class={tw`absolute right-4 top-4`}
                />
            </div>
            ...
            <div class={tw`relative`}>
                ...
                <OnFocusTransitionButton
                    onFocus={() => {
                        navigator.clipboard.writeText(originalEventRaw);
                    }}
                    class={tw`absolute right-4 top-4`}
                />
            </div>
