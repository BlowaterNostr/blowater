...
import { CenterClass, IconButtonClass, InputClass } from "./components/tw.ts";
import {
...
export class SpaceSetting extends Component<SpaceSettingProps, SpaceSettingState> {
    ...
    render(props: SpaceSettingProps) {
        return (
            <div class="h-[60dvh] w-[95dvw] sm:w-[80dvw] md:w-[60dvw] bg-neutral-700 rounded-xl">
                <div class="w-full h-full flex flex-col p-[1rem]">
                    <div class="flex flex-row grow">
                        <div class="text-xl font-semibold leading-7 flex-1">Space Settings</div>
                        <button
                            class="w-6 min-w-[1.5rem] h-6 focus:outline-none focus-visible:outline-none rounded-full hover:bg-[#36393F] z-10 flex items-center justify-center "
                            onClick={async () => {
                                await props.emit({
                                    type: "HideModal",
                                });
                    ...
                    <div class="flex flex-row h-[90%]">
                        <div class="h-full flex flex-col">
                            <div
                                class="flex flex-row p-2 hover:bg-[#737373] hover:rounded-lg mt-2 cursor-pointer"
