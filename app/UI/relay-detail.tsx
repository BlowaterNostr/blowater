                ...
                <div class="w-full h-full flex flex-col p-[1rem]">
                    ...
                    <div class="flex flex-row h-[90%]">
                        <div class="h-full flex flex-col pr-[1rem]">
                            <div
                                class={`flex flex-row items-center p-2 hover:bg-neutral-500 rounded-lg mt-2 hover:cursor-pointer ${
                            ...
                            >
                                ...
                                >
                                    <path
                                        ...
                                        fill={`${state.tab == "general" ? "white" : "#D4D4D4"}`}
                                    />
                                </svg>
                                <div>General</div>
                            </div>
                            ...
                            >
                                ...
                                >
                                    <path
                                        ...
                                        fill={`${state.tab == "members" ? "white" : "#D4D4D4"}`}
                                    />
                                </svg>
                                <div>Members</div>
                            </div>
